...
{
    public class Functions_Multiply_Generated
    {
        private readonly ServiceProvider serviceProvider;

        public Functions_Multiply_Generated()
        {
        ...
        public Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyResponse Multiply(Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyRequest __request__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            ...
            var response = functions.Multiply(x, y, __context__);
